...
class VisualInterface:
    ...
    def nextQuery(self, lbl_queryStr):
        ...
        self.sample_episode[self.topicId], self.action_list[self.topicId] = Agent.rank(curr_doc_list, 
                                                                                        self.topicId, 
                                                                                        self.W, self.data)
    ...
    def update(self, decay_value, len_add_docs, gamma, num_features, learning_rate, window_size):
        ...
        self.W = Agent.update(self.W, self.userFeedbacks, self.doc_M_rs, self.query_doc_K_dict, self.sample_episode, 
                            gamma, num_features, learning_rate, self.data)
...
def main():
    ...
    visual_obj = VisualInterface(window, N)
    ...
    visual_obj.sample_episode[visual_obj.topicId], visual_obj.action_list[visual_obj.topicId] = Agent.rank(curr_doc_list, 
                                                                                                            visual_obj.topicId, 
                                                                                                            visual_obj.W, visual_obj.data)
