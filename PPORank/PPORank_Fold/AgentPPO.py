...
class Agent:
    def __init__(self, n_actions, data, input_dims, gamma=1, alpha=0.0003, beta=0.001, gae_lambda=0.95,
                 policy_clip=0.2, batch_size=5, n_epochs=10, nodes=45):
        self.gamma = gamma
        ...
        self.actor = ActorNetwork(n_actions, input_dims, alpha, fc1_dims=nodes)
        self.critic = CriticNetwork(input_dims, beta, fc1_dims=nodes)
    ...
    def learn(self, c1, c2):
        ...
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                ...
                total_loss = actor_loss + c1 * critic_loss - c2 * dist_entropy
