...
class Dataset:
    def __init__(self, dataset, nf):
        self.QUERY_TRAIN, self.QUERY_VALI, self.QUERY_TEST, self.QUERY_DOC, self.QUERY_DOC_TRUTH, \
            self.DOC_REPR, self.MAX_DCG = transform(dataset, nf)
