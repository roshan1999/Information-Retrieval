...
if __name__ == '__main__':
    ...
    theta,W,results=Train_Full_Split_epochupdate(data,n_features, theta,W,epochs,alpha_actor,alpha_critic,gamma,seed,trainprop)
    #print("**************************Training Complete******************************")
    
    ds=get_name(datadir)
    add_info="allSplit_optimaction_uepoch_irandn_seed"+str(seed)
