...
if __name__ == '__main__':
    ...
    theta,W,results=Train_Full_Split_stepupdate(data,n_features, theta,W,epochs,alpha_actor,alpha_critic,gamma,seed,trainprop)
    #print("**************************Training Complete******************************")
    
    ds=get_name(datadir)
    add_info="allSplit_optimaction_ustep_irandn_seed"+str(seed)
