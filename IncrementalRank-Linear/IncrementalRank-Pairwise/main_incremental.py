...
if __name__ == '__main__':
    ...
    theta,W,results=Train_Full_Split_Incremental_Pairwise(data,n_features,theta,W,epochs,alpha_actor,alpha_critic,gamma,seed,n_step,trainprop)
    #print("**************************Training Complete******************************")
    
    ds=get_name(datadir)
    add_info="allSplit-incremental-pairwise-iac_randn-nstep_"+str(n_step)+"-seed_"+str(seed)+"-trainprop_"+str(trainprop)
